...
**짧은 설명**
```
冇實體魔方都可以喺手機上轉動。逐步學習，卡住時話你知下一步。
```
**자세한 설명**
```
冇實體魔方，一樣可以喺手機上轉。
滑動一行就可以轉嗰一層，兩隻手指拖曳可以反轉成個魔方。
...
■ 提示 — 如果中途卡住
話你知目前狀態下嘅下一步同原因。
提示跟返你學過嘅方法，唔係最短解法，所以每次提示都係一次複習。
展開圖會標出而家應該睇嘅塊。

■ 練習 — 如果你已經識還原
打亂同計時 2×2、3×3、4×4。
支援 15 秒觀察、最佳成績、ao5 同 ao12。

■ 匯入你嘅實體魔方
用相機影六個面，顏色會被辨識並搬到螢幕上。
亦可以自己揀顏色手動塗。
無法還原嘅配色會說明原因並攔住
（連角塊被扭轉呢種肉眼難以發現嘅情況都查得到）。
